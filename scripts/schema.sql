...
-- Many-to-many: which boat types a manual applies to
-- A shared engine manual can be linked to multiple boat types without duplicating embeddings
...
-- RPC for vector similarity search, filtered by boat type via junction table
...
-- ──────────────────────────────────────────────────────────────────────────────
-- Migration from old schema (boat_type_id on manual_chunks):
--
-- Step 1: populate the junction table from existing chunk associations
